...
if (category == null) {
	response.sendRedirect("OwnerCategoriesServlet");
	return;
}
%>
<!DOCTYPE html>
...
<body>
	<div class="wrapper">
		...
		<div class="main">
			<h1>Edit Category</h1>
			<p style="margin: 10px 0 25px; color: #666;">Update category
				information.</p>

			<div class="card">
				<form action="CategoryManagementServlet?action=update" method="post">
					...
					<div class="grid">
						...
						<div class="full">
							<label>Image Path</label> <input type="text" name="imagePath"
								value="<%=category.getImagePath()%>" required>
						</div>

					</div>

					<div class="buttons">
						<button class="save" type="submit">Update Category</button>
