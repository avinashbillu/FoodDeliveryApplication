...
<link
	...
	rel="stylesheet">
<meta charset="UTF-8">
<title>Add Menu Item - FoodHub</title>
<link
	href="https://cdn.jsdelivr.net/npm/remixicon@4.3.0/fonts/remixicon.css"
	rel="stylesheet">
<link
...
<body>
	<div class="wrapper">
		...
		<div class="main">
			...
			<p style="margin: 10px 0 25px; color: #666">Fill the details
				below to add a new dish.</p>
			<div class="card">
					...
					<div class="grid">
						...
						<div>
							<label>Image Path</label><input type="text" name="imagePath"
								placeholder="images/biryani.jpg" required>
						</div>
						<div>
							<label>Availability</label><select name="available"><option
									value="true">Available</option>
								<option value="false">Unavailable</option></select>
						</div>
					</div>
					<div class="buttons">
						<button class="save" type="submit">Save Menu Item</button>
